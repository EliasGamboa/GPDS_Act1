...
namespace AdminisEmpleados
{
    public class Startup
    {
        ...
        //El método ConfigureServices realiza una implementación de servicios que tiene MVVM y los externos basados en librerias de clases
